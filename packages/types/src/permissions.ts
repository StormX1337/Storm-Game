...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  {
    key: Permission.SERVERS_KILL,
    category: 'power',
    description: 'Forcefully kill a server process',
  },
  {
    key: Permission.SERVERS_REINSTALL,
    category: 'server',
    description: 'Reinstall a server from its template',
  },
  {
    key: Permission.SERVERS_SUSPEND,
    category: 'server',
  ...
  { key: Permission.SERVERS_CONSOLE, category: 'console', description: 'Read live console output' },
  {
    ...
    category: 'console',
    description: 'Send commands to the console',
  },
  {
    key: Permission.SERVERS_FILES,
    category: 'file',
    description: 'Browse and download server files',
  },
  {
    key: Permission.SERVERS_FILES_WRITE,
    category: 'file',
    description: 'Create, edit, upload and delete files',
  },
  ...
  {
    key: Permission.SERVERS_DATABASES_CREATE,
    category: 'database',
    description: 'Create server databases',
  },
  {
    key: Permission.SERVERS_DATABASES_DELETE,
    category: 'database',
    description: 'Delete server databases',
  },
  { key: Permission.SERVERS_SCHEDULES, category: 'schedule', description: 'View schedules' },
  {
    key: Permission.SERVERS_SCHEDULES_MANAGE,
    category: 'schedule',
    description: 'Create, edit and run schedules',
  },
  {
    key: Permission.SERVERS_ALLOCATIONS,
    category: 'network',
    description: 'Manage server network allocations',
  },
  {
    key: Permission.SERVERS_STARTUP,
    category: 'server',
    description: 'Change the startup command and image',
  },
  {
    key: Permission.SERVERS_VARIABLES,
    category: 'server',
    description: 'Change server environment variables',
  },
  ...
  {
    key: Permission.ALLOCATIONS_MANAGE,
    category: 'admin',
    description: 'Manage node IP allocations',
  },
  {
    key: Permission.DATABASE_HOSTS_MANAGE,
    category: 'admin',
    description: 'Manage database hosts',
  },
  {
    key: Permission.BACKUP_STORAGE_MANAGE,
    category: 'admin',
    description: 'Manage backup storage targets',
  },
  ...
  {
    key: Permission.ADMIN_SERVERS,
    category: 'admin',
    description: 'Act on every server in the panel',
  },
  { key: Permission.ADMIN_USERS, category: 'admin', description: 'Act on every user in the panel' },
  {
    key: Permission.ADMIN_DASHBOARD,
    category: 'admin',
    description: 'Access the administration area',
  },
  {
    key: Permission.PANEL_UPDATE,
    category: 'admin',
    description: 'Check for and apply panel updates',
  },
];
