...
```json
{
  "success": true,
  "data": {
    "user": { "id": "…", "email": "…", "username": "…", "role": "CUSTOMER", "permissions": ["servers.view", "…"] },
    "accessToken": "eyJ…",
    "expiresIn": 900
  }
}
...
```json
{
  ...
  "tasks": [{ "action": "command", "payload": "say Restarting in 60s" },
...
| `GET/POST /admin/webhooks`, `PATCH/DELETE /admin/webhooks/:id` | `settings.manage` |
| `GET /admin/webhooks/events` · `/admin/webhooks/:id/deliveries` | `settings.manage` |
